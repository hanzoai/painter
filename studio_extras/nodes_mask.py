...
def composite(destination, source, x, y, mask = None, multiplier = 8, resize_source = False):
    ...
    source = studio.utils.repeat_to_batch_size(source, destination.shape[0])
    ...
    if mask is None:
        ...
        mask = studio.utils.repeat_to_batch_size(mask, source.shape[0])
...
# https://github.com/cubiq/Studio_essentials/blob/9d9f4bedfc9f0321c19faf71855e228c93bd0dc9/mask.py#L81
...
class MaskPreview(nodes.SaveImage):
    ...
    def execute(self, mask, filename_prefix="Studio", prompt=None, extra_pnginfo=None):
