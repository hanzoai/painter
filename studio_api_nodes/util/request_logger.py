...
def get_log_directory():
    """Ensures the API log directory exists within Studio's temp directory and returns its path."""
...
if __name__ == '__main__':
    ...
    # Mock folder_paths for direct execution if not running within Studio full context
