...
class StudioNode(BaseModel):
    ...
    studio_node_name: Optional[str] = Field(
...
class StudioNodeCloudBuildInfo(BaseModel):
...
class Project(str, Enum):
    studioui = 'studioui'
    studioui_frontend = 'studioui_frontend'
    desktop = 'desktop'
...
class ActionJobResult(BaseModel):
    ...
    studio_run_flags: Optional[str] = Field(
        None, description='The studio run flags. E.g. `--low-vram`'
    )
    commit_hash: Optional[str] = Field(None, description='The hash of the commit')
...
class NodeVersion(BaseModel):
    ...
    studio_node_extract_status: Optional[str] = Field(
        None, description='The status of studio node extraction process.'
    )
    createdAt: Optional[datetime] = Field(
    ...
    supported_studioui_frontend_version: Optional[str] = Field(
        None, description='Supported versions of Studio frontend'
    )
    supported_studioui_version: Optional[str] = Field(
        None, description='Supported versions of Studio'
    )
...
class Node(BaseModel):
    ...
    preempted_studio_node_names: Optional[List[str]] = Field(
        None, description='A list of Studio node names that are preempted by this node.'
    )
