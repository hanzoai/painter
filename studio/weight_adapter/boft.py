...
class BOFTAdapter(WeightAdapterBase):
    ...
    def calculate_weight(
        ...
        blocks = studio.model_management.cast_to_device(blocks, weight.device, intermediate_dtype)
        if rescale is not None:
            rescale = studio.model_management.cast_to_device(rescale, weight.device, intermediate_dtype)
        ...
        try:
            ...
            lora_diff = inp - org
            lora_diff = studio.model_management.cast_to_device(lora_diff, weight.device, intermediate_dtype)
