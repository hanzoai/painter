...
import studio.ops
from studio.ldm.modules.diffusionmodules.mmdit import Mlp, TimestepEmbedder, PatchEmbed
from studio.ldm.modules.diffusionmodules.util import timestep_embedding
...
class HunYuanDiT(nn.Module):
    ...
    def forward(self,
        ...
        padding = studio.ops.cast_to_input(self.text_embedding_padding, text_states)
