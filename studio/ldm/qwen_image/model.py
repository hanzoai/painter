...
from studio.ldm.modules.attention import optimized_attention_masked
...
class QwenImageTransformer2DModel(nn.Module):
    ...
    def process_img(self, x, index=0, h_offset=0, w_offset=0):
        ...
        hidden_states = studio.ldm.common_dit.pad_to_patch_size(x, (1, self.patch_size, self.patch_size))
