...
import studio.ldm.modules.attention
...
class CrossAttention(nn.Module):
    ...
    def forward(self, x, context=None, mask=None, pe=None, transformer_options={}):
        ...
        if mask is None:
            out = studio.ldm.modules.attention.optimized_attention(q, k, v, self.heads, attn_precision=self.attn_precision, transformer_options=transformer_options)
        else:
            out = studio.ldm.modules.attention.optimized_attention_masked(q, k, v, self.heads, mask, attn_precision=self.attn_precision, transformer_options=transformer_options)
...
class BasicTransformerBlock(nn.Module):
    ...
    def forward(self, x, context=None, attention_mask=None, timestep=None, pe=None, transformer_options={}):
        ...
        attn1_input = studio.ldm.common_dit.rms_norm(x)
        ...
        y = studio.ldm.common_dit.rms_norm(x)
