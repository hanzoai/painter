...
from studio.ldm.flux.layers import EmbedND, DoubleStreamBlock, SingleStreamBlock

from studio.ldm.chroma.model import Chroma, ChromaParams
from studio.ldm.chroma.layers import (
    Approximator,
)
from .layers import (
    NerfEmbedder,
...
class ChromaRadiance(Chroma):
    ...
    def _forward(
        ...
        **kwargs: dict,
        ...
        bs, c, h, w = x.shape
        img = studio.ldm.common_dit.pad_to_patch_size(x, (self.patch_size, self.patch_size))
