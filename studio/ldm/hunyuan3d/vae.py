...
# Since the header on their VAE source file was a bit confusing we asked for permission to use this code from tencent under the GPL license used in Studio.
...
class CrossAttentionProcessor:
    def __call__(self, attn, q, k, v):
        out = studio.ops.scaled_dot_product_attention(q, k, v)
        return out
