...
from studio.ldm.modules.diffusionmodules.mmdit import TimestepEmbedder
...
class NextDiT(nn.Module):
    ...
    def forward(self, x, timesteps, context, num_tokens, attention_mask=None, **kwargs):
        return studio.patcher_extension.WrapperExecutor.new_class_executor(
            self._forward,
            self,
            studio.patcher_extension.get_all_wrappers(studio.patcher_extension.WrappersMP.DIFFUSION_MODEL, kwargs.get("transformer_options", {}))
