...
from studio.ldm.modules.diffusionmodules.model import ResnetBlock, AttnBlock, VideoConv3d, Normalize
import studio.ops
import studio.ldm.models.autoencoder
...
class RMS_norm(nn.Module):
    ...
    def forward(self, x):
        return F.normalize(x, dim=1) * self.scale * studio.model_management.cast_to(self.gamma, dtype=x.dtype, device=x.device)
...
class Encoder(nn.Module):
    def __init__(self, in_channels, z_channels, block_out_channels, num_res_blocks,
        ...
        self.regul = studio.ldm.models.autoencoder.DiagonalGaussianRegularizer()
