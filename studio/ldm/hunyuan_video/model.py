...
import studio.ldm.flux.layers
import studio.ldm.modules.diffusionmodules.mmdit
...
from studio.ldm.flux.layers import (
    DoubleStreamBlock,
    EmbedND,
    LastLayer,
    MLPEmbedder,
...
class HunyuanVideo(nn.Module):
    ...
    def __init__(self, image_model=None, final_layer=True, dtype=None, device=None, operations=None, **kwargs):
        ...
        self.img_in = studio.ldm.modules.diffusionmodules.mmdit.PatchEmbed(None, self.patch_size, self.in_channels, self.hidden_size, conv3d=len(self.patch_size) == 3, dtype=dtype, device=device, operations=operations)
        ...
        if self.vision_in_dim is not None:
            from studio.ldm.wan.model import MLPProj
