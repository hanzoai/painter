...
from .node_typing import IO, InputTypeDict, StudioNodeABC, CheckLazyMixin, FileLocator


class UnetApplyFunction(Protocol):
    """Function signature protocol on studio.model_base.BaseModel.apply_model"""
