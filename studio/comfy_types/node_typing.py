...
class InputTypeOptions(TypedDict):
    ...
    Ref: https://github.com/Studio-Org/Studio_frontend/pull/3364
    """
    ...
    Ref: https://github.com/Studio-Org/Studio_frontend/pull/3548
    """
    ...
    https://github.com/Studio-Org/Studio_frontend/pull/3550"""
    ...
    Available after Studio frontend v1.9.7
    https://github.com/Studio-Org/Studio_frontend/pull/2422"""
    ...
    Available after Studio frontend v1.13.4
    https://github.com/Studio-Org/Studio_frontend/pull/2987"""
...
class StudioNodeABC(ABC):
    ...
    In order to tell Studio that the list being returned should not be wrapped, but treated as a series of data for sequential processing,
