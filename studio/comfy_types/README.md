# Studio Typing
## Type hinting for Studio Node development

This module provides type hinting and concrete convenience types for node developers.
If cloned to the custom_nodes directory of Studio, types can be imported using:

```python
from studio.studio_types import IO, StudioNodeABC, CheckLazyMixin

class ExampleNode(StudioNodeABC):
    @classmethod
