...
import studio.utils
from studio.patcher_extension import WrappersMP
from typing import TYPE_CHECKING, Callable, Optional
if TYPE_CHECKING:
    from studio.model_patcher import ModelPatcher
    from studio.patcher_extension import WrapperExecutor
    ...
    def apply_torch_compile_wrapper(executor: WrapperExecutor, *args, **kwargs):
        try:
            ...
            for key, value in compiled_module_dict.items():
                orig_modules[key] = studio.utils.get_attr(executor.class_obj, key)
                studio.utils.set_attr(executor.class_obj, key, value)
